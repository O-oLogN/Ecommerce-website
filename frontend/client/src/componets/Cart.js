        ...
        <div className="mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mx-auto mt-8 max-w-2xl md:mt-12">
            <div className="bg-white shadow">
              {cart?.map((data) => (
                <div key={data.itemId} className="flow-root p-4 border-b">
                  <ul className="-my-8">
                    <li className="flex flex-col space-y-3 py-6 text-left sm:flex-row sm:space-x-5 sm:space-y-0">
                      ...
                      <div className="relative flex flex-1 flex-col justify-between">
                          ...
                          <div className="mt-4 flex items-end justify-between sm:mt-0 sm:items-start sm:justify-end">
                            ...
                            <div className="sm:order-1">
                              <div className="mx-auto flex h-8 items-stretch text-gray-600 sm:float-left">
                                <button
                                  onClick={() => dispatch(decreaseItemQuantity(data.itemId))
                                  }
                                ...
                                <button
                                  onClick={() => dispatch(increaseItemQuantity(data.itemId))
                                  }
                        ...
                        <div className="absolute top-0 right-0 flex sm:bottom-0 sm:top-auto">
                          <button
                            onClick={() => dispatch(removeFromCart(data.itemId))}
                            type="button"
